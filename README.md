...
📖 __Soft__Skills:__ <br/>Front-End: HTML, CSS, JavaScript, TypeScript;<br/>Framework: Bootstrap, React, Vue;<br/>Pré-processadores: SASS, LESS;<br/>Automatizadores: Gulp, Grunt;<br/>Back-End: Node, PHP;<br/>Banco-de-Dados: MongoDB, PostgreSQL, MySQL;<br/>API-Client: Postman, Insomnia;<br/><br/>
